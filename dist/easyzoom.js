    ...
    EasyZoom.prototype._move = function(e) {
        ...
        if (e.type.indexOf('touch') === 0) {
            ...
            */
            ...
            pointerPositionX = e.pageX || pointerPositionX; //e.pageX || pointerPositionX;
            pointerPositionY = e.pageY || pointerPositionY; //e.pageY || pointerPositionY;
        }
...
window.addEventListener("mousemove", function(e) {
    ...
    passive_touch.style.left = (px + x + 10) + "px";
    passive_touch.style.top = (py + y + 10) + "px";
});
*/
